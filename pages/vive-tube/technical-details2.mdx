...
**Homepage:** https://www.vivescriptsolutions.com/shop/subscription/vive-tube
...
Whether you're a creator, marketer, or data analyst, ViveTube saves time and improves decision-making with structured, spreadsheet-friendly metrics. The tool offers flexible plans, including a free version and a 15-day trial of premium features, making it ideal for YouTubers of all sizes.
...
- **Application Logo:** https://www.vivescriptsolutions.com/assets/images/vive-tube/vive-tube-logo.png
...
- **`https://www.googleapis.com/auth/script.container.ui`**
  - **Justification:** Used to create the add-on's custom menu (`📺 ViveTube`) and display sidebars (`AppDashboard`, `ChannelInfo`, `SettingsSidebar`, `HelpSidebar`, `ReportSetup`) and modal dialogs (`SubscriptionPlans`) within the Google Sheets interface.
...
4.  **Testing:**
    - Open a Google Sheet.
    - The "📺 ViveTube" menu should appear (you might need to refresh or authorize the script for the current document first).
...
- **Support URL:** https://www.vivescriptsolutions.com/support/vive-tube
- **Privacy Policy URL:** https://doc.vivescriptsolutions.com/vive-tube/privacy-policy
- **Terms of Service URL:** https://doc.vivescriptsolutions.com/vive-tube/terms-of-service
