...
ViveTube offers a range of features to bring powerful YouTube analytics directly into your Google Sheets.
...
- **Custom Dashboards:** Use standard Google Sheets functions and charts to build custom dashboards with ViveTube data.

### 4. Easy-to-Use Interface

- **Sidebar Controls:** Manage connections and data fetching through an intuitive sidebar.
- **Custom Functions (Optional):** Potentially use custom `=VIVETUBE_GETDATA()` style functions directly in cells.
